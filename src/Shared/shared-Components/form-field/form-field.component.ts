...
export class FormFieldComponent {
  ...
  requiredImage(): any {
    if (this.required) {
      ...
      return 'assets/Images/Login/Icons/check.svg'; // Not touched, but required
    } else if (this.touched) {
      this.requiredClass = 'text-[#47D764]';
      return 'assets/Images/Login/Icons/green-check.svg'; // Valid case
    }

    this.requiredClass = 'text-[#2C2C54]';
    return 'assets/Images/Login/Icons/check.svg'; // Default case
  }
  emailImage():any{
